...
exports.postJob = (req, res) =>{
    Request.postJob(req.body.q1,req.body.q2,req.body.q3,req.body.q4,req.body.q5,req.body.q6,req.params.userId)
    .then(result => res.json(checkAndChange(result)))
    .catch(error => res.json(checkAndChange(new Error(error))))
}
exports.postPartner = (req, res) =>{
    Request.postPartner(req.body.pseudo,req.body.email,req.body.age,req.body.q1,req.body.q2,req.body.q3,req.body.q4,req.body.q4,req.body.q5,req.body.q6,req.params.userId)
    .then(result => res.json(checkAndChange(result)))
    .catch(error => res.json(checkAndChange(new Error(error))))
}
